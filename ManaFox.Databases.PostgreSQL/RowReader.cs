...
{
    public class RowReader(NpgsqlDataReader underlying) : DbDataReader, IRowReader, IAsyncDisposable
    {
        private readonly NpgsqlDataReader Underlying = underlying;
        ...
        public static RowReader For(NpgsqlDataReader r) => new(r);
